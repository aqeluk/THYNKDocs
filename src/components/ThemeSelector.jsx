...
const themes = [
  { name: 'Light', value: 'light', icon: IoSunnyOutline },
  { name: 'Dark', value: 'dark', icon: IoMoonOutline },
  { name: 'System', value: 'system', icon: IoDesktopOutline },
]
...
export function ThemeSelector(props) {
  ...
  return (
    ...
    >
      ...
      >
        <IoSunnyOutline className="hidden h-4 w-4 fill-sky-400 [[data-theme=light]_&]:block" />
        <IoMoonOutline className="hidden h-4 w-4 fill-sky-400 [[data-theme=dark]_&]:block" />
        <IoSunnyOutline className="hidden h-4 w-4 fill-slate-400 [:not(.dark)[data-theme=system]_&]:block" />
        <IoMoonOutline className="hidden h-4 w-4 fill-slate-400 [.dark[data-theme=system]_&]:block" />
      </Listbox.Button>
